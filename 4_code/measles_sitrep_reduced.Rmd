...
## set current week 
reporting_week <- aweek::as.aweek("2020-W21")

## set one week prior to reporting week
last_reporting_week <- as.aweek("2020-W20")
...
## Health centre data
 linelist_hc_raw <- rio::import(here::here("data", "raw",
                                        "HC May 27_ W 21_line list + W 22 partial.xlsx"),
                             sheet = "Linelist CS") 


## Hospital data
 linelist_hosp_raw <- rio::import(here::here("data", "raw",
                                        "Hosp_May_27_W21_Line list + W22 partial.xlsx"),
...
ggplot(ar_age_group, aes(x = factor(age_group,
  ...
  labs(x = "Age group", y = "AR (per 10,000 for affected sub prefectures)", 
...
<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/// attack_rate_by_commune\\\
--------------------------------------------------------------------------------
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
Attack rate per 10,000 population by commune
